...
extern void pform_class_event_property(const struct vlltype&loc,
				 property_qualifier_t pq,
...
extern void pform_begin_sva_declaration();
extern void pform_end_sva_declaration();
extern bool pform_in_sva_declaration();
