...
static const struct opcode_table_s opcode_table[] = {
      ...
      { "%assoc/delete",of_ASSOC_DELETE,1,{OA_FUNC_PTR, OA_NONE, OA_NONE} },
      { "%assoc/exists",of_ASSOC_EXISTS,1,{OA_FUNC_PTR, OA_NONE, OA_NONE} },
      { "%assoc/first",of_ASSOC_FIRST,1,{OA_FUNC_PTR, OA_NONE, OA_NONE} },
      { "%assoc/last",of_ASSOC_LAST,1,{OA_FUNC_PTR, OA_NONE, OA_NONE} },
      { "%assoc/next",of_ASSOC_NEXT,1,{OA_FUNC_PTR, OA_NONE, OA_NONE} },
      { "%assoc/num",of_ASSOC_NUM,1,{OA_FUNC_PTR, OA_NONE, OA_NONE} },
      { "%assoc/prev",of_ASSOC_PREV,1,{OA_FUNC_PTR, OA_NONE, OA_NONE} },
      ...
      { "%clear_rand_bounds", of_CLEAR_RAND_BOUNDS, 0, {OA_NONE, OA_NONE, OA_NONE} },
      ...
      { "%config_db/get/dar", of_CONFIG_DB_GET_DAR, 1, {OA_NUMBER, OA_NONE, OA_NONE} },
      { "%config_db/get/o", of_CONFIG_DB_GET_O, 1, {OA_FUNC_PTR, OA_NONE, OA_NONE} },
      { "%config_db/get/prop", of_CONFIG_DB_GET_PROP, 1, {OA_NUMBER, OA_NONE, OA_NONE} },
      ...
      { "%cvg/sample",  of_CVG_SAMPLE,  2, {OA_NUMBER, OA_BIT1, OA_NONE} },
      ...
      { "%dand",     of_DAND,   2,{OA_FUNC_PTR,OA_BIT1,OA_NONE} },
      ...
      { "%dmax",     of_DMAX,   1,{OA_FUNC_PTR,OA_NONE,OA_NONE} },
      { "%dmin",     of_DMIN,   1,{OA_FUNC_PTR,OA_NONE,OA_NONE} },
      { "%dor",      of_DOR,    2,{OA_FUNC_PTR,OA_BIT1,OA_NONE} },
      { "%dproduct", of_DPRODUCT,2,{OA_FUNC_PTR,OA_BIT1,OA_NONE} },
      { "%dreverse", of_DREVERSE,1,{OA_FUNC_PTR,OA_NONE,OA_NONE} },
      { "%drsort",   of_DRSORT,  1,{OA_FUNC_PTR,OA_NONE,OA_NONE} },
      { "%dshuffle", of_DSHUFFLE,1,{OA_FUNC_PTR,OA_NONE,OA_NONE} },
      { "%dsort",    of_DSORT,   1,{OA_FUNC_PTR,OA_NONE,OA_NONE} },
      { "%dsum",     of_DSUM,   2,{OA_FUNC_PTR,OA_BIT1,OA_NONE} },
      ...
      { "%dxor",     of_DXOR,   2,{OA_FUNC_PTR,OA_BIT1,OA_NONE} },
      ...
      { "%fork/virt", of_FORK_VIRT, 2, {OA_CODE_PTR2,OA_VPI_PTR,  OA_NONE} },
      { "%free",   of_FREE,   1,  {OA_VPI_PTR,  OA_NONE,     OA_NONE} },
      { "%get/dar/obj/o",of_GET_DAR_OBJ_O,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%get/dar/obj/vec4",of_GET_DAR_OBJ_VEC4,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      ...
      { "%mailbox/get",     of_MAILBOX_GET,     1, {OA_BIT1, OA_NONE, OA_NONE} },
      { "%mailbox/new",     of_MAILBOX_NEW,     1, {OA_BIT1, OA_NONE, OA_NONE} },
      { "%mailbox/num",     of_MAILBOX_NUM,     0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%mailbox/peek",    of_MAILBOX_PEEK,    0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%mailbox/put",     of_MAILBOX_PUT,     0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%mailbox/try_get", of_MAILBOX_TRY_GET, 0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%mailbox/try_peek",of_MAILBOX_TRY_PEEK,0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%mailbox/try_put", of_MAILBOX_TRY_PUT, 0, {OA_NONE, OA_NONE, OA_NONE} },
      ...
      { "%prop/assoc/delete",of_PROP_ASSOC_DELETE,1, {OA_NUMBER,  OA_NONE, OA_NONE} },
      { "%prop/assoc/exists",of_PROP_ASSOC_EXISTS,1, {OA_NUMBER,  OA_NONE, OA_NONE} },
      { "%prop/assoc/first",of_PROP_ASSOC_FIRST,1, {OA_NUMBER,  OA_NONE, OA_NONE} },
      { "%prop/assoc/last",of_PROP_ASSOC_LAST,1, {OA_NUMBER,  OA_NONE, OA_NONE} },
      { "%prop/assoc/next",of_PROP_ASSOC_NEXT,1, {OA_NUMBER,  OA_NONE, OA_NONE} },
      { "%prop/assoc/num",of_PROP_ASSOC_NUM,1, {OA_NUMBER,  OA_NONE, OA_NONE} },
      { "%prop/assoc/prev",of_PROP_ASSOC_PREV,1, {OA_NUMBER,  OA_NONE, OA_NONE} },
      ...
      { "%prop/q/popb/o",of_PROP_Q_POPB_O,1, {OA_NUMBER,  OA_NONE, OA_NONE} },
      { "%prop/q/popf",  of_PROP_Q_POPF,  2, {OA_NUMBER,  OA_BIT1, OA_NONE} },
      { "%prop/q/popf/o",of_PROP_Q_POPF_O,1, {OA_NUMBER,  OA_NONE, OA_NONE} },
      ...
      { "%qmax/m",     of_QMAX_M,     3,{OA_FUNC_PTR,OA_BIT1,OA_BIT2} },
      { "%qmax_index", of_QMAX_INDEX, 1,{OA_FUNC_PTR,OA_NONE,OA_NONE} },
      { "%qmin",       of_QMIN,       1,{OA_FUNC_PTR,OA_NONE,OA_NONE} },
      { "%qmin/m",     of_QMIN_M,     3,{OA_FUNC_PTR,OA_BIT1,OA_BIT2} },
      { "%qmin_index", of_QMIN_INDEX, 1,{OA_FUNC_PTR,OA_NONE,OA_NONE} },
	...
	/* Queue property method stubs (data from stacks) */
      ...
      { "%qprop/max_index",  of_QPROP_MAX_INDEX,   0,{OA_NONE,OA_NONE,OA_NONE} },
      { "%qprop/min_index",  of_QPROP_MIN_INDEX,   0,{OA_NONE,OA_NONE,OA_NONE} },
      { "%qprop/qb/o",       of_QPROP_QB_O,        1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%qprop/qb/v",       of_QPROP_QB_V,        1,{OA_NUMBER,OA_NONE,OA_NONE} },
      ...
      { "%qrsort",     of_QRSORT,     1,{OA_FUNC_PTR,OA_NONE,OA_NONE} },
      { "%qrsort/m",   of_QRSORT_M,   3,{OA_FUNC_PTR,OA_BIT1,OA_BIT2} },
      ...
      { "%qunique_index/m", of_QUNIQUE_INDEX_M, 3,{OA_FUNC_PTR,OA_BIT1,OA_BIT2} },
      ...
      { "%semaphore/get", of_SEMAPHORE_GET, 1, {OA_BIT1, OA_NONE, OA_NONE} },
      { "%semaphore/new", of_SEMAPHORE_NEW, 1, {OA_BIT1, OA_NONE, OA_NONE} },
      { "%semaphore/put", of_SEMAPHORE_PUT, 1, {OA_BIT1, OA_NONE, OA_NONE} },
      { "%semaphore/try_get", of_SEMAPHORE_TRY_GET, 1, {OA_BIT1, OA_NONE, OA_NONE} },
      { "%set/dar/obj/o",of_SET_DAR_OBJ_O,1,{OA_NUMBER,OA_NONE,OA_NONE} },
      { "%set/dar/obj/pv",of_SET_DAR_OBJ_PV,3,{OA_NUMBER,OA_BIT1,OA_BIT2} },
      ...
      { "%store/dar/o",   of_STORE_DAR_O,   1,{OA_FUNC_PTR, OA_NONE, OA_NONE} },
      ...
      { "%store/prop/assoc/vec4",of_STORE_PROP_ASSOC_VEC4,2, {OA_NUMBER,  OA_BIT1, OA_NONE} },
      ...
      { "%store/prop/v/s",of_STORE_PROP_VS, 3, {OA_NUMBER,  OA_BIT1, OA_BIT2} },
      { "%store/prop/va", of_STORE_PROP_VA, 2, {OA_NUMBER,  OA_BIT1, OA_NONE} },
      ...
      { "%test_nul/dar", of_TEST_NUL_DAR, 1,{OA_NUMBER,  OA_NONE,    OA_NONE} },
      { "%test_nul/obj", of_TEST_NUL_OBJ, 0,{OA_NONE,    OA_NONE,    OA_NONE} },
      { "%test_nul/prop",of_TEST_NUL_PROP,2,{OA_NUMBER,  OA_BIT1,    OA_NONE} },
      { "%vif/load/obj",of_VIF_LOAD_OBJ,1, {OA_STRING,  OA_NONE,    OA_NONE} },
      { "%vif/load/v",  of_VIF_LOAD_V,  2, {OA_STRING,  OA_BIT1,    OA_NONE} },
      { "%vif/store/obj",of_VIF_STORE_OBJ,1,{OA_STRING,  OA_NONE,    OA_NONE} },
