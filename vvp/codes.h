...
extern bool of_CAST(vthread_t thr, vvp_code_t code);
extern bool of_CAST_PROP(vthread_t thr, vvp_code_t code);
...
extern bool of_CONFIG_DB_GET_DAR(vthread_t thr, vvp_code_t code);
extern bool of_CONFIG_DB_GET_O(vthread_t thr, vvp_code_t code);
extern bool of_CONFIG_DB_GET_PROP(vthread_t thr, vvp_code_t code);
extern bool of_CONFIG_DB_GET_V(vthread_t thr, vvp_code_t code);
extern bool of_CONFIG_DB_SET_O(vthread_t thr, vvp_code_t code);
extern bool of_CONFIG_DB_SET_V(vthread_t thr, vvp_code_t code);
...
extern bool of_DSUM(vthread_t thr, vvp_code_t code);
extern bool of_DPRODUCT(vthread_t thr, vvp_code_t code);
extern bool of_DMIN(vthread_t thr, vvp_code_t code);
extern bool of_DMAX(vthread_t thr, vvp_code_t code);
extern bool of_DAND(vthread_t thr, vvp_code_t code);
extern bool of_DOR(vthread_t thr, vvp_code_t code);
extern bool of_DXOR(vthread_t thr, vvp_code_t code);
extern bool of_DREVERSE(vthread_t thr, vvp_code_t code);
extern bool of_DRSORT(vthread_t thr, vvp_code_t code);
extern bool of_DSHUFFLE(vthread_t thr, vvp_code_t code);
extern bool of_DSORT(vthread_t thr, vvp_code_t code);
...
extern bool of_LOAD_DAR_O(vthread_t thr, vvp_code_t code);
...
extern bool of_LOAD_SCOPE(vthread_t thr, vvp_code_t code);
...
extern bool of_QMAX_M(vthread_t thr, vvp_code_t code);
extern bool of_QMIN(vthread_t thr, vvp_code_t code);
extern bool of_QMIN_M(vthread_t thr, vvp_code_t code);
...
extern bool of_QFIND_STRUCT(vthread_t thr, vvp_code_t code);
extern bool of_QPOP_F_STR(vthread_t thr, vvp_code_t code);
extern bool of_QPOP_F_V(vthread_t thr, vvp_code_t code);
extern bool of_QPRODUCT(vthread_t thr, vvp_code_t code);
extern bool of_QPRODUCT_M(vthread_t thr, vvp_code_t code);
...
extern bool of_QSUM_M(vthread_t thr, vvp_code_t code);
extern bool of_QUNIQUE(vthread_t thr, vvp_code_t code);
extern bool of_QUNIQUE_M(vthread_t thr, vvp_code_t code);
extern bool of_QUNIQUE_INDEX(vthread_t thr, vvp_code_t code);
extern bool of_QUNIQUE_INDEX_M(vthread_t thr, vvp_code_t code);
...
extern bool of_PROP_Q_POPF(vthread_t thr, vvp_code_t code);
extern bool of_PROP_Q_POPF_O(vthread_t thr, vvp_code_t code);
...
extern bool of_PUSH_RAND_BOUND_PROP(vthread_t thr, vvp_code_t code);
extern bool of_PUSH_RAND_BOUND_STACK(vthread_t thr, vvp_code_t code);
extern bool of_PUSH_RAND_ARRAY_COPY(vthread_t thr, vvp_code_t code);
...
extern bool of_SEMAPHORE_NEW(vthread_t thr, vvp_code_t code);
extern bool of_SEMAPHORE_GET(vthread_t thr, vvp_code_t code);
extern bool of_SEMAPHORE_PUT(vthread_t thr, vvp_code_t code);
extern bool of_SEMAPHORE_TRY_GET(vthread_t thr, vvp_code_t code);
extern bool of_MAILBOX_NEW(vthread_t thr, vvp_code_t code);
extern bool of_MAILBOX_PUT(vthread_t thr, vvp_code_t code);
extern bool of_MAILBOX_GET(vthread_t thr, vvp_code_t code);
extern bool of_MAILBOX_TRY_PUT(vthread_t thr, vvp_code_t code);
extern bool of_MAILBOX_TRY_GET(vthread_t thr, vvp_code_t code);
extern bool of_MAILBOX_PEEK(vthread_t thr, vvp_code_t code);
extern bool of_MAILBOX_TRY_PEEK(vthread_t thr, vvp_code_t code);
extern bool of_MAILBOX_NUM(vthread_t thr, vvp_code_t code);
...
extern bool of_LOAD_ASSOC_VEC4(vthread_t thr, vvp_code_t code);
extern bool of_STORE_ASSOC_VEC4(vthread_t thr, vvp_code_t code);
extern bool of_STORE_ASSOC_R(vthread_t thr, vvp_code_t code);
...
extern bool of_QPROP_QB_V(vthread_t thr, vvp_code_t code);
extern bool of_QPROP_QB_O(vthread_t thr, vvp_code_t code);
extern bool of_QPROP_QF_V(vthread_t thr, vvp_code_t code);
extern bool of_QPROP_QF_O(vthread_t thr, vvp_code_t code);
extern bool of_QPROP_INSERT_V(vthread_t thr, vvp_code_t code);
extern bool of_QPROP_INSERT_O(vthread_t thr, vvp_code_t code);
extern bool of_QPROP_DELETE(vthread_t thr, vvp_code_t code);
extern bool of_QPROP_DELETE_ELEM(vthread_t thr, vvp_code_t code);
extern bool of_QPROP_MAX_INDEX(vthread_t thr, vvp_code_t code);
extern bool of_QPROP_MIN_INDEX(vthread_t thr, vvp_code_t code);
...
extern bool of_STORE_QF_O(vthread_t thr, vvp_code_t code);
...
extern bool of_TEST_NUL_DAR(vthread_t thr, vvp_code_t code);
